...
<head>
    ...
    <link rel="stylesheet" href="3faq_1.css">
</head>
    ...
    <div class="page-wrapper">
        ...
        <div class="container">
            <div class="py-4 py-lg-5 py-xl-8">
                <h6 class="font-weight-medium font-size-7 font-size-xs-25 text-center" style="font-family:Arial">Frequently Asked Questions</h6>
            </div>
                            ...
                            <div id="basicsAccordion">
                                ...
                                <div class="card rounded-0 border-0">
                                    <div class="card-collapse card-header p-0 bg-transparent border-bottom-0"
                                        ...
                                        <button type="button"
                                            ...
                                            <span class="mx-md-1">What is the difference between agriculture and farming?</span>
                                ...
                                <div class="card rounded-0 border-0 ">
                                    <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                        ...
                                        <h5 class="mb-0">
                                            <button type="button"
                                                ...
                                                <span class="mx-md-1" style="font-family:Arial">Which soil is most suitable for agriculture?
                                                </span>
                                                <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div id="basicsCollapseTwo" class="collapse" aria-labelledby="basicsHeadingTwo"
                                        ...
                                        <div class="card-body p-3 p-md-4">
                                            <div class=" m-1">
                                                <p class="mb-4 pb-1 font-size-2">Different soil types are found with unique physical, chemical and biological aspects. For example, alluvial soil is believed to be the most fertile soil with potassium and is appropriate for crops like sugarcane, paddy and others.
                                                </p>
                                ...
                                <div class="card rounded-0 border-0">
                                    <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                        ...
                                        <button type="button"
                                            ...
                                            <span class="mx-md-1"> What are some tractor trolley usages?</span>
                                            <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                    d="M0.000,-0.000 L15.000,-0.000 L15.000,2.000 L0.000,2.000 L0.000,-0.000 Z">
                                    ...
                                    <div id="basicsCollapseThree" class="collapse" aria-labelledby="basicsHeadingThree"
                                        ...
                                        <div class="card-body p-3 p-md-4">
                                            <div class="mx-md-1">
                                                <p class="mb-4 pb-1 font-size-2"> Tractor trolleys are used as quick transporters of agricultural planned and unplanned seeds, yields, harvests, fertilizers, etc. as per farmer’s needs. These are preferred over commercial transporters as they have both on-road and off-road capabilities.</p>
                                ...
                                <div class="card rounded-0 border-0">
                                    <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                        ...
                                        <button type="button"
                                            ...
                                            <span class="mx-1">What is a tractor subsidy?</span>
                                            <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                    d="M0.000,-0.000 L15.000,-0.000 L15.000,2.000 L0.000,2.000 L0.000,-0.000 Z">
                                    ...
                                    <div id="basicsCollapseFour" class="collapse" aria-labelledby="basicsHeadingFour"
                                        ...
                                        <div class="card-body p-3 p-md-4">
                                            <div class="mx-md-1">
                                                <p class="mb-4 pb-1 font-size-2">Govt. of India offers a provision of subsidy over new tractors for promoting the mechanisation component of the Macro-Management Scheme of Agriculture. The scheme is open to all categories of farmers and follows a general subsidy pattern.
                                        ...
                                        <div id="basicsAccordion1">
                                            ...
                                            <div class="card rounded-0 border-0">
                                                <div class="card-collapse card-header p-0 bg-transparent border-bottom-0"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span class="mx-md-1">How to apply for the benefits of the scheme?
                                                        </span>
                                                        <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                            <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                ...
                                                <div id="basicsCollapseFive" class="collapse"
                                                    aria-labelledby="basicsHeadingFive" data-parent="#basicsAccordion1">
                                                    <div class="card-body p-3 p-md-4">
                                                        <div class=" mx-md-1">
                                                            <p class="mb-4 pb-1 font-size-2">Bona fide farmers can apply in plain paper to the District Agriculture Officer of the
                                                                concerned Districts through Agriculture Development officer of C & RD Block/ Agriculture
                                                                Circle/Sub-Divisional Agricultural Officers of the concerned Sub-Divisions or directly to
                                                                the Research Officer of the Seed Testing Laboratory.</p>
                                            ...
                                            <div class="card rounded-0 border-0 ">
                                                <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                                    ...
                                                    <h5 class="mb-0">
                                                        <button type="button"
                                                            ...
                                                            aria-expanded="false" aria-controls="basicsCollapseSix">
                                                            <span class="mx-1" style="font-family:Arial"> What are the benefits of farming agreement for smallholders?
                                                            </span>
                                                            <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="15px"
                                                                height="2px">
                                                ...
                                                <div id="basicsCollapseSix" class="collapse" aria-labelledby="basicsHeadingSix"
                                                    ...
                                                    <div class="card-body p-3 p-md-4">
                                                        <div class="mx-md-1">
                                                            <p class="mb-4 pb-1 font-size-2">Farming agreement gives smallholder farmers the possibility of knowing in advance
                                                                when, to whom and at what price they will sell their products. This helps to reduce the
                                                                unpredictability of agriculture and allows them to better plan their production. When
                                                                sponsor also provides access to inputs including technical assistance, farming agreement
                                            ...
                                            <div class="card rounded-0 border-0">
                                                <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="basicsCollapseSeven">
                                                        <span class="mx-md-1">What are the good practices involved in preparing the farming agreement?</span>
                                                        <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                            <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                                d="M0.000,-0.000 L15.000,-0.000 L15.000,2.000 L0.000,2.000 L0.000,-0.000 Z">
                                                ...
                                                <div id="basicsCollapseSeven" class="collapse" aria-labelledby="basicsHeadingSeven"
                                                    ...
                                                    <div class="card-body p-3 p-md-4">
                                                        <div class="mx-md-1">
                                                            <p class="mb-4 pb-1 font-size-2">The whole agreement formation process should be carried out in a fair and
                                                                transparent manner and in good faith. A good practice is for farmers to be involved in
                                                                discussions with the sponsor from the beginning of the negotiation and contract formation
                                                                phases, to make sure they understand all the conditions included in the Agreement, and to
                                                                ensure that their interests and rights are considered.</p>
                                            ...
                                            <div class="card rounded-0 border-0">
                                                <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="basicsCollapseEight">
                                                        <span class="mx-md-1"> How the prices are determined in the farming agreement?
                                                        </span>
                                                        <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                            <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                ...
                                                <div id="basicsCollapseEight" class="collapse" aria-labelledby="basicsHeadingEight"
                                                    ...
                                                    <div class="card-body p-3 p-md-4">
                                                        <div class="mx-md-1">
                                                            <p class="mb-4 pb-1 font-size-2">There should be more transparency in the price determination of output. The
                                                                parties may negotiate in order to agree to a price, and both sides are expected to honour
                                                                this agreement. The price to be paid for the purchase of a farming produce has to be
                                                                determined and mentioned in the farming agreement itself. In case of variable price then
                                                                the provisions of the Act have to be strictly followed. The methodology for calculating
                                                                guaranteed price or additional price must be annexed to the agreement.</p>
                                            ...
                                            <div class="card rounded-0 border-0">
                                                <div class="card-header card-collapse p-0 bg-transparent border-bottom-0"
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        aria-expanded="false" aria-controls="basicsCollapseNine">
                                                        <span class="mx-md-1">Is organic no-till farming possible?</span>
                                                        <svg class="minus" xmlns="http://www.w3.org/2000/svg"
                                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="15px" height="2px">
                                                            <path fill-rule="evenodd" fill="rgb(22, 22, 25)"
                                                                d="M0.000,-0.000 L15.000,-0.000 L15.000,2.000 L0.000,2.000 L0.000,-0.000 Z">
                                                ...
                                                <div id="basicsCollapseNine" class="collapse" aria-labelledby="basicsHeadingNine"
                                                    ...
                                                    <div class="card-body p-3 p-md-4">
                                                        <div class="mx-md-1">
                                                            <p class="mb-4 pb-1 font-size-2">Organic no-till farming is completely possible, it’s just a little more difficult for large commercial farms.
                                                                ...
                                                                Cover crops cover the ground, prevent new weeds from growing and live in harmony with regular crops.</p>
...
<script src="3faq_1.js"></script>
<script src="3faq_2.js"></script>
